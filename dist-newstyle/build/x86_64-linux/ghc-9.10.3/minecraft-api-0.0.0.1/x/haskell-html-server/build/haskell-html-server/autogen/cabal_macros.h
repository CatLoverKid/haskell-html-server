...
/* package minecraft-api-0.0.0.1 */
#ifndef VERSION_minecraft_api
#define VERSION_minecraft_api "0.0.0.1"
#endif /* VERSION_minecraft_api */
#ifndef MIN_VERSION_minecraft_api
#define MIN_VERSION_minecraft_api(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_minecraft_api */
...
#define CURRENT_COMPONENT_ID "minecraft-api-0.0.0.1-inplace-haskell-html-server"
