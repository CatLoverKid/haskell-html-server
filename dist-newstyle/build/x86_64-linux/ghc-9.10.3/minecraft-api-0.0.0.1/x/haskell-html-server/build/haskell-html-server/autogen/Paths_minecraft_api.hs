...
-- at runtime using the environment variable minecraft_api_bindir.
...
-- environment variable minecraft_api_libdir.
...
-- using the environment variable minecraft_api_dynlibdir.
...
-- runtime using the environment variable minecraft_api_datadir.
...
-- variable minecraft_api_libexedir.
...
-- using the environment variable minecraft_api_sysconfdir.
...
bindir     = "/home/akeba/.cabal/bin"
libdir     = "/home/akeba/.cabal/lib/x86_64-linux-ghc-9.10.3-2929/minecraft-api-0.0.0.1-inplace-haskell-html-server"
dynlibdir  = "/home/akeba/.cabal/lib/x86_64-linux-ghc-9.10.3-2929"
datadir    = "/home/akeba/.cabal/share/x86_64-linux-ghc-9.10.3-2929/minecraft-api-0.0.0.1"
libexecdir = "/home/akeba/.cabal/libexec/x86_64-linux-ghc-9.10.3-2929/minecraft-api-0.0.0.1"
sysconfdir = "/home/akeba/.cabal/etc"

getBinDir     = catchIO (getEnv "minecraft_api_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "minecraft_api_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "minecraft_api_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "minecraft_api_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "minecraft_api_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "minecraft_api_sysconfdir") (\_ -> return sysconfdir)
